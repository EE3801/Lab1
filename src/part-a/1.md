...
> <p class="task"> Task
>
> Submit your account number to the Canvas Ungraded Survey (under Quizzes) named "Information for Labs", along with the NUS email address you used to create your AWS account, and the kind of computer you will be using to complete the labs (e.g. Windows, Mac, Linux). We will use the kind of computer you will be using to group you up with TAs that have experience using the same type of computer.
> 
> ![alt text](Picture3.png)
>
> This will allow us to invite you to our AWS Organization, which will cover the charges you incur while working on the labs. Look out for the email invitation and accept it in order to be added to our AWS Organization. 
>
...
For Windows users using WSL or Linux users, you should see something like:
...
The number 1675 above shows that the file is 1675 bytes in size, which is what you would expect. If your file has a size of 0, that means something went wrong and you will need to remove the file and regenerate it.
