...
Get your account number from the AWS Management Console by clicking your username in the top right:
...
## 1. Miniconda
> <p class="warn"> Windows users: Install WSL 2 first with the default Ubuntu distribution of Linux before following the instructions to install miniconda for a Linux system:
> 
...
Create a conda environment named "aws":
