...
When prompted, use “ap-southeast-1” for region, and enter the Key ID and Secret Key from the CSV above when prompted.
...
Copy a file to your EC2 instance using the secure copy command "scp" (replace the highlighted text below with the IP address you obtained above):
